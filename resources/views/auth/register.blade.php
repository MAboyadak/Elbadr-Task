                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="profile_image" name="profile_image" type="file" class="form-control @error('profile_image') is-invalid @enderror" value="{{ old('profile_image') }}" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="drive_licence" name="drive_licence" type="file" class="form-control @error('drive_licence') is-invalid @enderror" value="{{ old('drive_licence') }}" >
                        ...
                        <input id="latitude" type="hidden" class="form-control" name="latitude" value="{{ old('latitude') }}" >
                        <input id="longitude" type="hidden" class="form-control" name="longitude" value="{{ old('longitude') }}" >
...
@section('scripts')
    ...
    {{-- <script src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_MAP_KEY')}}&libraries=places&callback=initAutocomplete&language=ar&region=EG"></script> --}}
